# MsgSearchCommand Bot - `msgSearchCommandBot`
...
3. Give the bot a handle (ex: `msgSearchCommandBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://teamsmsgextsearch.azurewebsites.net/api/messages`
