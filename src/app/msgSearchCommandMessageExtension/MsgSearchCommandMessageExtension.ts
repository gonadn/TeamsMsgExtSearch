...
@PreventIframe("/msgSearchCommandMessageExtension/config.html")
export default class MsgSearchCommandMessageExtension implements IMessagingExtensionMiddlewareProcessor {
